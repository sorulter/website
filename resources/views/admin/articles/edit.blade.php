            ...
            <div class="box-body">
                ...
                <div class="form-group col-xs-6">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" value="{{$article->created_at}}" disabled>
                    </div>
                </div>
                ...
                <div class="form-group col-xs-6">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" value="{{$article->updated_at}}" disabled>
                    </div>
                </div>
                ...
                <div class="form-group col-xs-12">
                    ...
                    @endif
                    <textarea class="form-control" rows="3" placeholder="Enter ..." name="content">{{$article->content}}</textarea>
                </div>
                <!-- /.form group -->
