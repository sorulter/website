                    ...
                    <tbody>
                        @if ($user->activate == 1)
                            <tr>
                                ...
                                <td><span title="{{$user->flows->Free}} Bytes">{{number_format($user->flows->forever/MB, 2)}} MB</span></td>
                            </tr>
                            <tr>
                                <td><span><i class="fa fa-rmb"></i>&emsp;{{trans('home.combo_flows')}}</span></td>
                                <td><span title="{{$user->flows->combo_flows}} Bytes">{{number_format($user->flows->combo/MB, 2)}} MB</span></td>
                            </tr>
                            <tr>
            ...
            <div class="box-body">
                <table class="table table-striped">
                    <tbody>
                        ...
                        <tr>
                            <td>QQ</td>
                            <td><a target="_blank" href="http://shang.qq.com/wpa/qunwpa?idkey=c46a231370e89b87bcc9e1355d6852c355ba9866b012a78c94eca520cc207486"><img border="0" src="https://pub.idqqimg.com/wpa/images/group.png" alt="iProxier" title="iProxier"></a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
