        ...
        <div class="box-body">
            <div class="row">
                <div class="col-sm-4 text-center">
                    <a href="{{route('user/cellular/config', 'cmcc')}}" target="_blank">
                ...
                <div class="col-sm-4 text-center">
                    <a href="{{route('user/cellular/config', 'telcom')}}" target="_blank">
                ...
                <div class="col-sm-4 text-center">
                    <a href="{{route('user/cellular/config', 'unicom')}}" target="_blank">
